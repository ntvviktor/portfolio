...
func styling() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_styling_113d`,
		Function: `function __templ_styling_113d(){document.addEventListener('DOMContentLoaded', () => {
		...
		*/
		...
		Call:       templ.SafeScript(`__templ_styling_113d`),
		CallInline: templ.SafeScriptInline(`__templ_styling_113d`),
	}
}
